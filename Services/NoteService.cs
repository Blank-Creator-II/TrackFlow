...
public static class NoteService
{
    public static bool SaveNote(Note n)
    {
        ...
        string note_data_location = Path.Combine(FileHelper.BASE_DIR,"Note",$"note_{DateTime.Now:yyyyMMdd_HHmmss}.txt"); // creates a sanitized unique data file to store at just like expense and others
